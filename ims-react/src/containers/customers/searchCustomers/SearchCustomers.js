...
const SearchCustomers = observer(({customerSearchStore, referenceDataStore}) => {
  ...
  return(
    <Container>
      <Row><h1 className="margin-30">Search Customers</h1></Row>
      <Formik
      initialValues={{
        firstName: '',
        lastName: '',
            ...
            <CwigCard>
              ...
              <Form.Row>
                <Form.Group as={Col} md="4">
                  ...
                  <Form.Control placeholder="Organization" name="organization" onChange={formikProps.handleChange}></Form.Control>
                </Form.Group>
                <Form.Group as={Col} md="4">
                ...
                <Form.Group as={Col} md="4">
                  ...
                  <Form.Control placeholder="Phone Number" name="phone" onChange={formikProps.handleChange}></Form.Control>
                </Form.Group>
              </Form.Row>
